...
public class SeparatedStarList extends SGLL implements IParserTest{
	...
	private final static IConstructor PROD_SEPSTARLIST_A_b = vf.constructor(Factory.Production_Regular, SYMBOL_SEP_STAR_LIST_A, vf.constructor(Factory.Attributes_NoAttrs));
	...
	public static void main(String[] args){
		...
		IConstructor result = nrsl.parse(NONTERMINAL_START_S, null, "ababa".toCharArray());
