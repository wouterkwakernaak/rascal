...
public abstract class Statement extends org.rascalmpl.ast.Statement {
	...
	static public class Solve extends org.rascalmpl.ast.Statement.Solve {
		...
		public Solve(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.QualifiedName> __param2,
				org.rascalmpl.ast.Bound __param3,
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			try {
				java.util.List<org.rascalmpl.ast.QualifiedName> varList = this
						.getVariables();
				...
				if (bound.isDefault()) {
					...
					max = ((org.eclipse.imp.pdb.facts.IInteger) res.getValue())
							.intValue();
					if (max <= 0) {
						throw org.rascalmpl.interpreter.utils.RuntimeExceptionFactory
								.indexOutOfBounds(
										(org.eclipse.imp.pdb.facts.IInteger) res
												.getValue(), __eval
				...
				while (change && (max == -1 || iterations < max)) {
					...
					for (int i = 0; i < size; i++) {
						...
						org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> v = __eval
								.getCurrentEnvt().getVariable(var);
	...
	static public class Break extends org.rascalmpl.ast.Statement.Break {
		...
		public Break(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Target __param2) {
	...
	static public class VariableDeclaration extends
		...
		public VariableDeclaration(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.LocalVariableDeclaration __param2) {
			super(__param1, __param2);
		}
	...
	static public class Fail extends org.rascalmpl.ast.Statement.Fail {
		...
		public Fail(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Target __param2) {
			super(__param1, __param2);
		}
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			if (!this.getTarget().isEmpty()) {
				throw new org.rascalmpl.interpreter.control_exceptions.Failure(
						this.getTarget().getName().toString());
			}
	...
	static public class Insert extends org.rascalmpl.ast.Statement.Insert {
		...
		public Insert(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.DataTarget __param2,
	...
	static public class Try extends org.rascalmpl.ast.Statement.Try {
		...
		public Try(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Statement __param2,
				java.util.List<org.rascalmpl.ast.Catch> __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class AssertWithMessage extends
		...
		public AssertWithMessage(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				...
				org.eclipse.imp.pdb.facts.IString msg = __eval.__getVf()
						.string(
								org.rascalmpl.interpreter.utils.Utils.unescape(
										msgValue.getValue().toString(), this,
	...
	static public class Append extends org.rascalmpl.ast.Statement.Append {
		...
		public Append(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.DataTarget __param2,
				org.rascalmpl.ast.Statement __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			if (__eval.__getAccumulators().empty()) {
				throw new org.rascalmpl.interpreter.staticErrors.AppendWithoutLoop(
						this);
			}
			if (!this.getDataTarget().isEmpty()) {
				java.lang.String label = org.rascalmpl.interpreter.utils.Names
						.name(this.getDataTarget().getLabel());
				for (org.rascalmpl.interpreter.Accumulator accu : __eval
						.__getAccumulators()) {
				...
				if (target == null) {
					throw new org.rascalmpl.interpreter.staticErrors.AppendWithoutLoop(
							this); // TODO: better error message
				}
			} else {
	...
	static public class IfThen extends org.rascalmpl.ast.Statement.IfThen {
		...
		public IfThen(org.eclipse.imp.pdb.facts.INode __param1,
				...
				org.rascalmpl.ast.Statement __param4,
				org.rascalmpl.ast.NoElseMayFollow __param5) {
	...
	static public class Switch extends org.rascalmpl.ast.Statement.Switch {
		...
		public Switch(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Label __param2,
				org.rascalmpl.ast.Expression __param3,
				java.util.List<org.rascalmpl.ast.Case> __param4) {
			super(__param1, __param2, __param3, __param4);
		}
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			for (org.rascalmpl.ast.Case cs : this.getCases()) {
				...
				if (rule.isArbitrary()
					...
					throw new org.rascalmpl.interpreter.asserts.NotYetImplemented(
							rule);
				}
			}
			return null;
	...
	static public class While extends org.rascalmpl.ast.Statement.While {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			__eval.__getAccumulators().push(
					new org.rascalmpl.interpreter.Accumulator(__eval.__getVf(),
							label));
			...
			loop: while (true) {
				...
				org.eclipse.imp.pdb.facts.IValue value = __eval
						.__getAccumulators().pop().done();
				return org.rascalmpl.interpreter.result.ResultFactory
	...
	static public class Return extends org.rascalmpl.ast.Statement.Return {
		...
		public Return(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Statement __param2) {
			super(__param1, __param2);
		}
	...
	static public class NonEmptyBlock extends
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> r = org.rascalmpl.interpreter.result.ResultFactory
					.nothing();
			org.rascalmpl.interpreter.env.Environment old = __eval
					.getCurrentEnvt();
	...
	static public class GlobalDirective extends
		...
		public GlobalDirective(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Type __param2,
				java.util.List<org.rascalmpl.ast.QualifiedName> __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class TryFinally extends
		...
		public TryFinally(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Statement __param2,
				java.util.List<org.rascalmpl.ast.Catch> __param3,
				org.rascalmpl.ast.Statement __param4) {
			super(__param1, __param2, __param3, __param4);
	...
	static public class Continue extends org.rascalmpl.ast.Statement.Continue {
		...
		public Continue(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Target __param2) {
			super(__param1, __param2);
		}
	...
	static public class Throw extends org.rascalmpl.ast.Statement.Throw {
		...
		public Throw(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Statement __param2) {
			super(__param1, __param2);
		}
	...
	static public class Assert extends org.rascalmpl.ast.Statement.Assert {
		...
		public Assert(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2) {
			super(__param1, __param2);
		}
