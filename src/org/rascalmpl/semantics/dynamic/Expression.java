...
public abstract class Expression extends org.rascalmpl.ast.Expression {
	...
	static public class StepRange extends
		...
		public StepRange(org.eclipse.imp.pdb.facts.INode __param1,
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			throw new org.rascalmpl.interpreter.staticErrors.UnsupportedPatternError(
					this.toString(), this);
	...
	static public class And extends org.rascalmpl.ast.Expression.And {
		...
		public And(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
	...
	static public class TransitiveClosure extends
		...
		public TransitiveClosure(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2) {
	...
	static public class MultiVariable extends
		...
		public MultiVariable(org.eclipse.imp.pdb.facts.INode __param1,
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> variable = __eval
					.getCurrentEnvt().getVariable(name);

			if (variable == null) {
				throw new org.rascalmpl.interpreter.staticErrors.UndeclaredVariableError(
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			return new org.rascalmpl.interpreter.matching.MultiVariablePattern(
					__eval.__getCtx(), this, this.getQualifiedName());
		...
		public org.rascalmpl.interpreter.matching.IBooleanResult __evaluate(
			...
			throw new org.rascalmpl.interpreter.staticErrors.SyntaxError(this
					.toString(), this.getLocation());
	...
	static public class NotIn extends org.rascalmpl.ast.Expression.NotIn {
		...
		public NotIn(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public org.rascalmpl.interpreter.matching.IBooleanResult __evaluate(
			...
			return new org.rascalmpl.interpreter.matching.BasicBooleanResult(
	...
	static public class CallOrTree extends
		...
		public CallOrTree(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.eclipse.imp.pdb.facts.IValue[] actuals = new org.eclipse.imp.pdb.facts.IValue[args
					.size()];
			org.eclipse.imp.pdb.facts.type.Type[] types = new org.eclipse.imp.pdb.facts.type.Type[args
					.size()];
			...
			org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> res = function
					.call(types, actuals);

			// we need to update the strategy context when the function is of
			// type Strategy
			org.rascalmpl.interpreter.strategy.IStrategyContext strategyContext = __eval
					.getStrategyContext();
			if (strategyContext != null) {
				if (function.getValue() instanceof org.rascalmpl.interpreter.result.AbstractFunction) {
					org.rascalmpl.interpreter.result.AbstractFunction f = (org.rascalmpl.interpreter.result.AbstractFunction) function
							.getValue();
					...
					org.rascalmpl.interpreter.result.OverloadedFunctionResult fun = (org.rascalmpl.interpreter.result.OverloadedFunctionResult) function
							.getValue();

					for (org.rascalmpl.interpreter.result.AbstractFunction f : fun
							.iterable()) {
						if (f.isTypePreserving()) {
							strategyContext.update(actuals[0], res.getValue());
						}
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			if (__eval.isConcreteSyntaxList(this)) {
				...
				// production itself?
				return new org.rascalmpl.interpreter.matching.ConcreteListPattern(
						__eval.__getCtx(), this, __eval.visitElements(args
								.getElements()));
			}
			if (__eval.isConcreteSyntaxAppl(this)) {
				if (org.rascalmpl.values.uptr.TreeAdapter
						.isLexical((org.eclipse.imp.pdb.facts.IConstructor) this
								.getTree())) {
					return new org.rascalmpl.interpreter.matching.ConcreteApplicationPattern(
							__eval.__getCtx(), this, __eval
									.visitConcreteLexicalArguments(this));
				} else {
					return new org.rascalmpl.interpreter.matching.ConcreteApplicationPattern(
							__eval.__getCtx(), this, __eval
									.visitConcreteArguments(this));
				}
			}
			if (__eval.isConcreteSyntaxAmb(this)) {
				new org.rascalmpl.interpreter.asserts.Ambiguous(
			...
			if (nameExpr.isQualifiedName()) {
				org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> prefix = __eval
						.__getCtx().getCurrentEnvt().getVariable(
				...
				if (nameExpr.isQualifiedName() && prefix == null) {
					return new org.rascalmpl.interpreter.matching.NodePattern(
							__eval.__getCtx(), this, null, nameExpr
									.getQualifiedName(), __eval
									.visitArguments(this));
				} else if (nameExpr.isQualifiedName()
						&& ((prefix instanceof org.rascalmpl.interpreter.result.AbstractFunction) || prefix instanceof org.rascalmpl.interpreter.result.OverloadedFunctionResult)) {
					return new org.rascalmpl.interpreter.matching.NodePattern(
							__eval.__getCtx(), this, null, nameExpr
									.getQualifiedName(), __eval
									.visitArguments(this));
	...
	static public class List extends org.rascalmpl.ast.Expression.List {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.eclipse.imp.pdb.facts.type.Type elementType = org.rascalmpl.interpreter.Evaluator
					.__getTf().voidType();
			...
			for (org.rascalmpl.ast.Expression expr : elements) {
				...
				org.eclipse.imp.pdb.facts.type.Type resultType = resultElem
						.getType();
				if (splicing
						&& resultType instanceof org.rascalmpl.interpreter.types.NonTerminalType) {
					org.eclipse.imp.pdb.facts.IConstructor sym = ((org.rascalmpl.interpreter.types.NonTerminalType) resultType)
							.getSymbol();

					if (org.rascalmpl.values.uptr.SymbolAdapter.isAnyList(sym)) {
						org.eclipse.imp.pdb.facts.IConstructor appl = ((org.eclipse.imp.pdb.facts.IConstructor) resultElem
								.getValue());
						org.eclipse.imp.pdb.facts.IList listElems = org.rascalmpl.values.uptr.TreeAdapter
								.getArgs(appl);
						...
						if (!listElems.isEmpty()) {
							...
							if (!first) {
								if (org.rascalmpl.values.uptr.SymbolAdapter
										.isCf(sym)) {
									org.eclipse.imp.pdb.facts.IConstructor listSym = org.rascalmpl.values.uptr.SymbolAdapter
											.getSymbol(sym);
									if (org.rascalmpl.values.uptr.SymbolAdapter
											.isIterStar(listSym)) {
										results.remove(results.size() - 1);
									} else if (org.rascalmpl.values.uptr.SymbolAdapter
											.isIterStarSep(listSym)) {
										results.remove(results.size() - 1);
										results.remove(results.size() - 1);
										results.remove(results.size() - 1);
									}
					...
					if (resultElem.getType().isListType()
						 ...
						 * __eval
						 */
						for (org.eclipse.imp.pdb.facts.IValue val : ((org.eclipse.imp.pdb.facts.IList) resultElem
								.getValue())) {
							elementType = elementType.lub(val.getType());
							results.add(val);
						}
			...
			org.eclipse.imp.pdb.facts.type.Type resultType = org.rascalmpl.interpreter.Evaluator
					.__getTf().listType(elementType);
			org.eclipse.imp.pdb.facts.IListWriter w = resultType.writer(__eval
					.__getVf());
			w.appendAll(results);
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			return new org.rascalmpl.interpreter.matching.ListPattern(__eval
					.__getCtx(), this, __eval.visitElements(this.getElements()));
	...
	static public class Map extends org.rascalmpl.ast.Expression.Map {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			java.util.List<org.rascalmpl.ast.Mapping> mappings = this
					.getMappings();
			...
			org.eclipse.imp.pdb.facts.type.Type keyType = org.rascalmpl.interpreter.Evaluator
					.__getTf().voidType();
			org.eclipse.imp.pdb.facts.type.Type valueType = org.rascalmpl.interpreter.Evaluator
					.__getTf().voidType();
			...
			for (org.rascalmpl.ast.Mapping mapping : mappings) {
				...
				org.eclipse.imp.pdb.facts.IValue keyValue = result
						.get(keyResult.getValue());
				if (keyValue != null) {
			...
			org.eclipse.imp.pdb.facts.type.Type type = org.rascalmpl.interpreter.Evaluator
					.__getTf().mapType(keyType, valueType);
			org.eclipse.imp.pdb.facts.IMapWriter w = type.writer(__eval
					.__getVf());
			w.putAll(result);
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			throw new org.rascalmpl.interpreter.asserts.ImplementationError(
					"Map in pattern not yet implemented");
	...
	static public class ReifyType extends
		...
		public ReifyType(org.eclipse.imp.pdb.facts.INode __param1,
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.eclipse.imp.pdb.facts.type.Type t = new org.rascalmpl.interpreter.TypeEvaluator(
					__eval.getCurrentEnvt(), __eval.__getHeap()).eval(this
					.getType());
			return t.accept(new org.rascalmpl.interpreter.TypeReifier(__eval,
					__eval.__getVf()));
	...
	static public class QualifiedName extends
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			org.eclipse.imp.pdb.facts.type.Type signature = org.rascalmpl.interpreter.PatternEvaluator
					.__getTf().tupleType(
							new org.eclipse.imp.pdb.facts.type.Type[0]);

			org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> r = __eval
					.__getCtx().getEvaluator().getCurrentEnvt().getVariable(
							name);

			if (r != null) {
				if (r.getValue() != null) {
					// Previously declared and initialized variable
					return new org.rascalmpl.interpreter.matching.QualifiedNamePattern(
							__eval.__getCtx(), this, name);
				}
				...
				if (type instanceof org.rascalmpl.interpreter.types.NonTerminalType) {
					...
					if (cType.isConcreteListType()) {
						return new org.rascalmpl.interpreter.matching.ConcreteListVariablePattern(
								__eval.__getCtx(), this, type,
	...
	static public class Match extends org.rascalmpl.ast.Expression.Match {
		...
		public Match(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public org.rascalmpl.interpreter.matching.IBooleanResult __evaluate(
			...
			return new org.rascalmpl.interpreter.matching.MatchResult(__eval
					.__getCtx(), this.getPattern(), true, this.getExpression());
	...
	static public class Visit extends org.rascalmpl.ast.Expression.Visit {
		...
		public Visit(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Label __param2,
	...
	static public class GreaterThanOrEq extends
		...
		public GreaterThanOrEq(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Tuple extends org.rascalmpl.ast.Expression.Tuple {
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			return new org.rascalmpl.interpreter.matching.TuplePattern(__eval
					.__getCtx(), this, __eval.visitElements(this.getElements()));
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.eclipse.imp.pdb.facts.IValue[] values = new org.eclipse.imp.pdb.facts.IValue[elements
					.size()];
			org.eclipse.imp.pdb.facts.type.Type[] types = new org.eclipse.imp.pdb.facts.type.Type[elements
					.size()];
			...
			return org.rascalmpl.interpreter.result.ResultFactory.makeResult(
					org.rascalmpl.interpreter.Evaluator.__getTf().tupleType(
							types), __eval.__getVf().tuple(values), __eval);
	...
	static public class Reducer extends org.rascalmpl.ast.Expression.Reducer {
		...
		public Reducer(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3,
	...
	static public class SetAnnotation extends
		...
		public SetAnnotation(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
	...
	static public class Modulo extends org.rascalmpl.ast.Expression.Modulo {
		...
		public Modulo(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Closure extends org.rascalmpl.ast.Expression.Closure {
		...
		public Closure(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Type __param2,
				org.rascalmpl.ast.Parameters __param3,
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.eclipse.imp.pdb.facts.type.Type formals = new org.rascalmpl.interpreter.TypeEvaluator(
					__eval.getCurrentEnvt(), __eval.__getHeap()).eval(this
					.getParameters());
			org.eclipse.imp.pdb.facts.type.Type returnType = __eval
					.evalType(this.getType());
			org.rascalmpl.interpreter.types.RascalTypeFactory RTF = org.rascalmpl.interpreter.types.RascalTypeFactory
					.getInstance();
			return new org.rascalmpl.interpreter.result.RascalFunction(this,
					__eval, (org.rascalmpl.interpreter.types.FunctionType) RTF
							.functionType(returnType, formals), this
							.getParameters().isVarArgs(), this.getStatements(),
					__eval.getCurrentEnvt(), __eval.__getAccumulators());
	...
	static public class GreaterThan extends
		...
		public GreaterThan(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Descendant extends
		...
		public Descendant(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2) {
			super(__param1, __param2);
		}
	...
	static public class Or extends org.rascalmpl.ast.Expression.Or {
		...
		public Or(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Anti extends org.rascalmpl.ast.Expression.Anti {
		...
		public Anti(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2) {
			super(__param1, __param2);
		}
	...
	static public class All extends org.rascalmpl.ast.Expression.All {
		...
		@Override
		public org.rascalmpl.interpreter.result.Result __evaluate(
				org.rascalmpl.interpreter.Evaluator __eval) {
			...
			org.rascalmpl.interpreter.env.Environment old = __eval
					.getCurrentEnvt();
			int i = 0;
			...
			try {
				...
				while (i >= 0 && i < size) {
					...
					if (gens[i].hasNext()) {
						if (!gens[i].next()) {
							return new org.rascalmpl.interpreter.result.BoolResult(
									org.rascalmpl.interpreter.Evaluator
											.__getTf().boolType(), __eval
			...
			return new org.rascalmpl.interpreter.result.BoolResult(
					...
					__eval.__getVf().bool(true), __eval);
	...
	static public class GetAnnotation extends
		...
		public GetAnnotation(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Name __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Negation extends org.rascalmpl.ast.Expression.Negation {
		...
		public Negation(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2) {
			super(__param1, __param2);
		}
	...
	static public class Composition extends
		...
		public Composition(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class LessThanOrEq extends
		...
		public LessThanOrEq(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class IfDefinedOtherwise extends
		...
		public IfDefinedOtherwise(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Literal extends org.rascalmpl.ast.Expression.Literal {
		...
		public Literal(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Literal __param2) {
			super(__param1, __param2);
		}
	...
	static public class Equivalence extends
		...
		public Equivalence(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class ReifiedType extends
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			java.util.List<org.rascalmpl.ast.Expression> args = this
					.getArguments();
			org.eclipse.imp.pdb.facts.type.Type[] fieldTypes = new org.eclipse.imp.pdb.facts.type.Type[args
					.size()];
			org.eclipse.imp.pdb.facts.IValue[] fieldValues = new org.eclipse.imp.pdb.facts.IValue[args
					.size()];
			...
			return type.accept(new org.rascalmpl.interpreter.TypeReifier(
					__eval, __eval.__getVf()));
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			org.rascalmpl.ast.BasicType basic = this.getBasicType();
			java.util.List<org.rascalmpl.interpreter.matching.IMatchingResult> args = __eval
					.visitElements(this.getArguments());

			return new org.rascalmpl.interpreter.matching.ReifiedTypePattern(
					__eval.__getCtx(), this, basic, args);
	...
	static public class LessThan extends org.rascalmpl.ast.Expression.LessThan {
		...
		public LessThan(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class VoidClosure extends
		...
		public VoidClosure(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Parameters __param2,
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			return new org.rascalmpl.interpreter.result.RascalFunction(this,
					__eval, (org.rascalmpl.interpreter.types.FunctionType) RTF
							.functionType(org.rascalmpl.interpreter.Evaluator
									.__getTf().voidType(), formals), this
							.getParameters().isVarArgs(), this.getStatements(),
					__eval.getCurrentEnvt(), __eval.__getAccumulators());
	...
	static public class TypedVariable extends
		...
		public TypedVariable(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Type __param2, org.rascalmpl.ast.Name __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			org.eclipse.imp.pdb.facts.type.Type type = new org.rascalmpl.interpreter.TypeEvaluator(
			...
			return new org.rascalmpl.interpreter.matching.TypedVariablePattern(
					__eval.__getCtx(), this, type, this.getName());
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> result = __eval
	...
	static public class Guarded extends org.rascalmpl.ast.Expression.Guarded {
		...
		public Guarded(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Type __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			if (expected instanceof org.rascalmpl.interpreter.types.NonTerminalType
					&& result.getType().isSubtypeOf(
				...
				try {
					java.lang.String command = '('
							...
							+ ')'
							+ '`'
							+ ((org.eclipse.imp.pdb.facts.IString) result
									.getValue()).getValue() + '`';
					org.eclipse.imp.pdb.facts.IConstructor tree = __eval
							.__getParser()
							.parseCommand(
									((org.rascalmpl.interpreter.env.ModuleEnvironment) __eval
											.getCurrentEnvt().getRoot())
											.getSDFImports(),
									__eval.__getSdf().getSdfSearchPath(),
									this.getLocation().getURI(), command);

					if (tree.getConstructorType() == Factory.ParseTree_Summary) {
						throw org.rascalmpl.interpreter.utils.RuntimeExceptionFactory
								.parseError(this.getPattern().getLocation(),
										this.getPattern(), __eval
												.getStackTrace());
					}

					tree = org.rascalmpl.values.uptr.ParsetreeAdapter
							.getTop(tree); // start rule
					tree = (org.eclipse.imp.pdb.facts.IConstructor) org.rascalmpl.values.uptr.TreeAdapter
							.getArgs(tree).get(1); // top command expression
					tree = (org.eclipse.imp.pdb.facts.IConstructor) org.rascalmpl.values.uptr.TreeAdapter
							.getArgs(tree).get(0); // typed quoted embedded
													// fragment
					tree = (org.eclipse.imp.pdb.facts.IConstructor) org.rascalmpl.values.uptr.TreeAdapter
							.getArgs(tree).get(8); // wrapped string between
													// `...`
					...
					throw org.rascalmpl.interpreter.utils.RuntimeExceptionFactory
							.io(__eval.__getVf().string(e.getMessage()), this
									.getPattern(), __eval.getStackTrace());
				}
			}
			if (!result.getType().isSubtypeOf(expected)) {
				throw new org.rascalmpl.interpreter.staticErrors.UnexpectedTypeError(
						expected, result.getType(), this.getPattern());
			}
	...
	static public class NoMatch extends org.rascalmpl.ast.Expression.NoMatch {
		...
		public NoMatch(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public org.rascalmpl.interpreter.matching.IBooleanResult __evaluate(
			...
			return new org.rascalmpl.interpreter.matching.MatchResult(__eval
					.__getCtx(), this.getPattern(), false, this.getExpression());
	...
	static public class Enumerator extends
		...
		public Enumerator(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.rascalmpl.interpreter.env.Environment old = __eval
					.getCurrentEnvt();
			try {
				org.rascalmpl.interpreter.matching.IBooleanResult gen = __eval
						.makeBooleanResult(this);
				gen.init();
				__eval.pushEnv();
	...
	static public class VariableBecomes extends
		...
		public VariableBecomes(org.eclipse.imp.pdb.facts.INode __param1,
	...
	static public class Negative extends org.rascalmpl.ast.Expression.Negative {
		...
		public Negative(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2) {
			super(__param1, __param2);
		}
	...
	static public class TransitiveReflexiveClosure extends
		...
		public TransitiveReflexiveClosure(
	...
	static public class Implication extends
		...
		public Implication(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class IsDefined extends
		...
		public IsDefined(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2) {
			super(__param1, __param2);
		}
	...
	static public class FieldProject extends
		...
		public FieldProject(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				java.util.List<org.rascalmpl.ast.Field> __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Equals extends org.rascalmpl.ast.Expression.Equals {
		...
		public Equals(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class FieldUpdate extends
		...
		public FieldUpdate(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Name __param3,
				org.rascalmpl.ast.Expression __param4) {
			super(__param1, __param2, __param3, __param4);
	...
	static public class Set extends org.rascalmpl.ast.Expression.Set {
		...
		public org.rascalmpl.interpreter.matching.IMatchingResult __evaluate(
			...
			return new org.rascalmpl.interpreter.matching.SetPattern(__eval
					.__getCtx(), this, __eval.visitElements(this.getElements()));
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			for (org.rascalmpl.ast.Expression expr : elements) {
				...
				if (resultElem.getType().isSetType()
					 ...
					 * __eval.
					 */
					for (org.eclipse.imp.pdb.facts.IValue val : ((org.eclipse.imp.pdb.facts.ISet) resultElem
							.getValue())) {
						elementType = elementType.lub(val.getType());
						results.add(val);
					}
			...
			org.eclipse.imp.pdb.facts.type.Type resultType = org.rascalmpl.interpreter.Evaluator
					.__getTf().setType(elementType);
			org.eclipse.imp.pdb.facts.ISetWriter w = resultType.writer(__eval
					.__getVf());
			w.insertAll(results);
			// Was: return makeResult(resultType, applyRules(w.done()));
			return org.rascalmpl.interpreter.result.ResultFactory.makeResult(
	...
	static public class TypedVariableBecomes extends
		...
		public TypedVariableBecomes(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Type __param2,
				org.rascalmpl.ast.Name __param3,
				org.rascalmpl.ast.Expression __param4) {
			super(__param1, __param2, __param3, __param4);
	...
	static public class In extends org.rascalmpl.ast.Expression.In {
		...
		public In(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Lexical extends org.rascalmpl.ast.Expression.Lexical {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			throw new org.rascalmpl.interpreter.asserts.NotYetImplemented(this);// TODO
	...
	static public class It extends org.rascalmpl.ast.Expression.It {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> v = __eval
					.getCurrentEnvt().getVariable(Evaluator.IT);
			if (v == null) {
				throw new org.rascalmpl.interpreter.staticErrors.ItOutsideOfReducer(
						this);
			}
			return v;
	...
	static public class Join extends org.rascalmpl.ast.Expression.Join {
		...
		public Join(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
	...
	static public class Ambiguity extends
			org.rascalmpl.ast.Expression.Ambiguity {
	...
	static public class NonEmptyBlock extends
		...
		public NonEmptyBlock(org.eclipse.imp.pdb.facts.INode __param1,
	...
	static public class Any extends org.rascalmpl.ast.Expression.Any {
		...
		public Any(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.Expression> __param2) {
			super(__param1, __param2);
		}
	...
	static public class NonEquals extends
		...
		public NonEquals(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Expression __param3) {
			super(__param1, __param2, __param3);
		}
