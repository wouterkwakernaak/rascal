...
public abstract class ShellCommand extends org.rascalmpl.ast.ShellCommand {
	...
	static public class SetOption extends
		...
		public SetOption(org.eclipse.imp.pdb.facts.INode __param1,
	...
	static public class Undeclare extends
			org.rascalmpl.ast.ShellCommand.Undeclare {

		public Undeclare(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.QualifiedName __param2) {
	...
	static public class Ambiguity extends
			org.rascalmpl.ast.ShellCommand.Ambiguity {

		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.ShellCommand> __param2) {
			super(__param1, __param2);
		}
	...
	static public class Unimport extends
		...
		public Unimport(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.QualifiedName __param2) {
			super(__param1, __param2);
		}
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			((org.rascalmpl.interpreter.env.ModuleEnvironment) __eval
					.getCurrentEnvt().getRoot()).unImport(this.getName()
					.toString());
			return org.rascalmpl.interpreter.result.ResultFactory.nothing();
	...
	static public class ListModules extends
			org.rascalmpl.ast.ShellCommand.ListModules {
	...
	static public class Edit extends org.rascalmpl.ast.ShellCommand.Edit {
		...
		public Edit(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.QualifiedName __param2) {
			super(__param1, __param2);
		}
