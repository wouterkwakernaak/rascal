...
public abstract class PatternWithAction extends
	...
	static public class Ambiguity extends
			org.rascalmpl.ast.PatternWithAction.Ambiguity {

		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.PatternWithAction> __param2) {
	...
	static public class Arbitrary extends
		...
		public Arbitrary(org.eclipse.imp.pdb.facts.INode __param1,
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			if (pv instanceof org.rascalmpl.interpreter.matching.NodePattern) {
				pt = ((org.rascalmpl.interpreter.matching.NodePattern) pv)
						.getConstructorType(__eval.getCurrentEnvt());
			}
	...
	static public class Replacing extends
		...
		public Replacing(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				org.rascalmpl.ast.Replacement __param3) {
			super(__param1, __param2, __param3);
		}
