...
public abstract class DateAndTime extends org.rascalmpl.ast.DateAndTime {
	...
	static public class Ambiguity extends
		...
		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.DateAndTime> __param2) {
	...
	static public class Lexical extends org.rascalmpl.ast.DateAndTime.Lexical {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			java.lang.String datePart = dtPart
					.substring(0, dtPart.indexOf("T"));
			java.lang.String timePart = dtPart
					.substring(dtPart.indexOf("T") + 1);
