...
public abstract class Declarator extends org.rascalmpl.ast.Declarator {
	...
	static public class Default extends org.rascalmpl.ast.Declarator.Default {
		...
		public Default(org.eclipse.imp.pdb.facts.INode __param1,
				...
				java.util.List<org.rascalmpl.ast.Variable> __param3) {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			for (org.rascalmpl.ast.Variable var : this.getVariables()) {
				java.lang.String varAsString = org.rascalmpl.interpreter.utils.Names
						.name(var.getName());
	...
	static public class Ambiguity extends
			org.rascalmpl.ast.Declarator.Ambiguity {

		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.Declarator> __param2) {
