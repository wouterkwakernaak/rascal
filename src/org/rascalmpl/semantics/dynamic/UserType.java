...
public abstract class UserType extends org.rascalmpl.ast.UserType {
	...
	static public class Name extends org.rascalmpl.ast.UserType.Name {
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			org.rascalmpl.interpreter.env.Environment theEnv = __eval
					.getEnvironmentForName(this.getName());
			java.lang.String name = org.rascalmpl.interpreter.utils.Names
					.typeName(this.getName());

			if (theEnv != null) {
				org.eclipse.imp.pdb.facts.type.Type type = theEnv
						.lookupAlias(name);
				...
				org.eclipse.imp.pdb.facts.type.Type tree = theEnv
				...
				org.eclipse.imp.pdb.facts.type.Type symbol = theEnv
						.lookupConcreteSyntaxType(name);
	...
	static public class Ambiguity extends org.rascalmpl.ast.UserType.Ambiguity {
		...
		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.UserType> __param2) {
			super(__param1, __param2);
		}
	...
	static public class Parametric extends
		...
		public Parametric(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.QualifiedName __param2,
				java.util.List<org.rascalmpl.ast.Type> __param3) {
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			if (type != null) {
				...
				org.eclipse.imp.pdb.facts.type.Type[] params = new org.eclipse.imp.pdb.facts.type.Type[this
						.getParameters().size()];
				...
				type.getTypeParameters().match(
						org.rascalmpl.interpreter.TypeEvaluator.__getTf()
								.tupleType(params), bindings);

				// Note that instantiation use type variables from the current
				// context, not the declaring context
				org.eclipse.imp.pdb.facts.type.Type outerInstance = type
						.instantiate(__eval.__getEnv().getTypeBindings());
