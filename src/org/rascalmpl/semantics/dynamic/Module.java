...
public abstract class Module extends org.rascalmpl.ast.Module {
	...
	static public class Ambiguity extends org.rascalmpl.ast.Module.Ambiguity {
		...
		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.Module> __param2) {
	...
	static public class Default extends org.rascalmpl.ast.Module.Default {
		...
		public Default(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Header __param2,
				org.rascalmpl.ast.Body __param3) {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.rascalmpl.interpreter.env.ModuleEnvironment env = __eval
					.__getHeap().getModule(name);
			...
			if (!env.isInitialized()) {
				org.rascalmpl.interpreter.env.Environment oldEnv = __eval
						.getCurrentEnvt();
