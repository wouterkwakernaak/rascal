...
public abstract class LocationLiteral extends org.rascalmpl.ast.LocationLiteral {
	...
	static public class Default extends
		...
		public Default(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.ProtocolPart __param2,
				org.rascalmpl.ast.PathPart __param3) {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			java.lang.String uri = ((org.eclipse.imp.pdb.facts.IString) protocolPart
					.getValue()).getValue()
					+ "://"
					+ ((org.eclipse.imp.pdb.facts.IString) pathPart.getValue())
							.getValue();

			try {
				java.net.URI url = new java.net.URI(uri);
				org.eclipse.imp.pdb.facts.ISourceLocation r = __eval.__getVf()
						.sourceLocation(url);
	...
	static public class Ambiguity extends
			org.rascalmpl.ast.LocationLiteral.Ambiguity {

		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.LocationLiteral> __param2) {
