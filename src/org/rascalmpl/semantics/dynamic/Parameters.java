...
public abstract class Parameters extends org.rascalmpl.ast.Parameters {
	...
	static public class VarArgs extends org.rascalmpl.ast.Parameters.VarArgs {
		...
		public VarArgs(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Formals __param2) {
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			if (arity == 0) {
				...
				return org.rascalmpl.interpreter.TypeEvaluator
						.__getTf()
						.tupleType(
								org.rascalmpl.interpreter.TypeEvaluator
										.__getTf()
										.listType(
												org.rascalmpl.interpreter.TypeEvaluator
														.__getTf().valueType()),
			...
			types[i] = org.rascalmpl.interpreter.TypeEvaluator.__getTf()
					.listType(formals.getFieldType(i));
			labels[i] = formals.getFieldName(i);
	...
	static public class Ambiguity extends
		...
		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.Parameters> __param2) {
			super(__param1, __param2);
		}
