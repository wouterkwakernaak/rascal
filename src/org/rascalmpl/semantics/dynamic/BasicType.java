...
public abstract class BasicType extends org.rascalmpl.ast.BasicType {
	...
	static public class ReifiedType extends
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			throw new org.rascalmpl.interpreter.staticErrors.NonWellformedTypeError(
		...
		@Override
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
				org.rascalmpl.interpreter.BasicTypeEvaluator __eval) {
					...
					return org.rascalmpl.interpreter.types.RascalTypeFactory
							...
							.reifiedType(
									org.rascalmpl.interpreter.types.RascalTypeFactory
											.getInstance()
											.nonTerminalType(
													(org.eclipse.imp.pdb.facts.IConstructor) __eval
	...
	static public class String extends org.rascalmpl.ast.BasicType.String {
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			return org.rascalmpl.interpreter.TypeEvaluator.__getTf()
					.stringType();
					...
					return org.rascalmpl.interpreter.types.RascalTypeFactory
							...
							.reifiedType(
									org.rascalmpl.interpreter.Typeifier
											.toType((org.eclipse.imp.pdb.facts.IConstructor) __eval
													.__getValueArguments()[0]));
				}
			}
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			if (__eval.__getValueArguments().length >= 1) {
				if (__eval.__getValueArguments()[0].getType().isStringType()) {
					name = ((org.eclipse.imp.pdb.facts.IString) __eval
							.__getValueArguments()[0]).getValue();
					org.eclipse.imp.pdb.facts.type.Type adt = __eval.__getEnv()
							.lookupAbstractDataType(name);
				...
				if (__eval.__getValueArguments().length == 2) {
					if (__eval.__getValueArguments()[1].getType().isListType()) {
						org.eclipse.imp.pdb.facts.IList list = (org.eclipse.imp.pdb.facts.IList) __eval
								.__getValueArguments()[1];
						org.eclipse.imp.pdb.facts.type.Type[] args = new org.eclipse.imp.pdb.facts.type.Type[list
								.length()];
						int i = 0;
						for (org.eclipse.imp.pdb.facts.IValue arg : list) {
							org.eclipse.imp.pdb.facts.type.Type argType = arg
									.getType();
	...
	static public class Loc extends org.rascalmpl.ast.BasicType.Loc {
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			throw new org.rascalmpl.interpreter.staticErrors.NonWellformedTypeError(
					"loc cannot have type arguments.", this);
	...
	static public class Num extends org.rascalmpl.ast.BasicType.Num {
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			throw new org.rascalmpl.interpreter.staticErrors.NonWellformedTypeError(
					"num cannot have type arguments.", this);
	...
	static public class Int extends org.rascalmpl.ast.BasicType.Int {
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			throw new org.rascalmpl.interpreter.staticErrors.NonWellformedTypeError(
					"int cannot have type arguments.", this);
	...
	static public class Ambiguity extends org.rascalmpl.ast.BasicType.Ambiguity {
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			throw new org.rascalmpl.interpreter.asserts.ImplementationError(
					"Detected ambiguity in BasicType", this.getLocation());
		...
		public org.eclipse.imp.pdb.facts.type.Type __evaluate(
			...
			throw new org.rascalmpl.interpreter.asserts.ImplementationError(
					"Ambiguity detected in BasicType", this.getLocation());
