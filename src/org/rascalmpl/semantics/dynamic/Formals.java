...
public abstract class Formals extends org.rascalmpl.ast.Formals {
	...
	static public class Ambiguity extends org.rascalmpl.ast.Formals.Ambiguity {
		...
		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.Formals> __param2) {
	...
	static public class Default extends org.rascalmpl.ast.Formals.Default {
		...
		public Default(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.Formal> __param2) {
			super(__param1, __param2);
		}
			...
			for (int formal = 0, index = 0; formal < list.size(); formal++, index++) {
				...
				if (type == null) {
					throw new org.rascalmpl.interpreter.staticErrors.UndeclaredTypeError(
							f.getType().toString(), f);
				}
				typesAndNames[index++] = type;
				typesAndNames[index] = org.rascalmpl.interpreter.utils.Names
						.name(f.getName());
			}
