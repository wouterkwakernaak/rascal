...
public abstract class Visit extends org.rascalmpl.ast.Visit {
	...
	static public class DefaultStrategy extends
		...
		public DefaultStrategy(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Expression __param2,
				java.util.List<org.rascalmpl.ast.Case> __param3) {
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.rascalmpl.interpreter.TraverseResult tr = te.traverse(subject
					.getValue(), te.new CasesOrRules(cases),
					DIRECTION.BottomUp, PROGRESS.Continuing, FIXEDPOINT.No);
	...
	static public class GivenStrategy extends
		...
		public GivenStrategy(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Strategy __param2,
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.rascalmpl.interpreter.TraversalEvaluator te = new org.rascalmpl.interpreter.TraversalEvaluator(
					__eval);
			org.rascalmpl.interpreter.TraverseResult tr = te.traverse(subject
					.getValue(), te.new CasesOrRules(cases), direction,
					progress, fixedpoint);
			org.eclipse.imp.pdb.facts.type.Type t = tr.value.getType();
			org.eclipse.imp.pdb.facts.IValue val = tr.value;
			org.rascalmpl.interpreter.TraverseResultFactory
	...
	static public class Ambiguity extends org.rascalmpl.ast.Visit.Ambiguity {
		...
		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.Visit> __param2) {
