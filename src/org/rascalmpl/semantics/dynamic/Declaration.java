...
public abstract class Declaration extends org.rascalmpl.ast.Declaration {
	...
	static public class View extends org.rascalmpl.ast.Declaration.View {
		...
		public View(org.eclipse.imp.pdb.facts.INode __param1,
				...
				org.rascalmpl.ast.Name __param4,
				org.rascalmpl.ast.Name __param5,
				java.util.List<org.rascalmpl.ast.Alternative> __param6) {
	...
	static public class Test extends org.rascalmpl.ast.Declaration.Test {
		...
		public Test(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Test __param2) {
	...
	static public class Alias extends org.rascalmpl.ast.Declaration.Alias {
		...
		public Alias(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Tags __param2,
				org.rascalmpl.ast.Visibility __param3,
				org.rascalmpl.ast.UserType __param4,
				org.rascalmpl.ast.Type __param5) {
		...
		public org.rascalmpl.ast.Declaration __evaluate(
			...
			__eval.__getAliasDecls().add(this);
			return this;
	...
	static public class Annotation extends
		...
		public Annotation(org.eclipse.imp.pdb.facts.INode __param1,
				...
				org.rascalmpl.ast.Type __param5, org.rascalmpl.ast.Name __param6) {
			super(__param1, __param2, __param3, __param4, __param5, __param6);
		}
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			org.eclipse.imp.pdb.facts.type.Type annoType = new org.rascalmpl.interpreter.TypeEvaluator(
					__eval.getCurrentModuleEnvironment(), __eval.__getHeap())
					.eval(this.getAnnoType());
			java.lang.String name = org.rascalmpl.interpreter.utils.Names
					.name(this.getName());

			org.eclipse.imp.pdb.facts.type.Type onType = new org.rascalmpl.interpreter.TypeEvaluator(
					__eval.getCurrentModuleEnvironment(), __eval.__getHeap())
					.eval(this.getOnType());
	...
	static public class Ambiguity extends
			org.rascalmpl.ast.Declaration.Ambiguity {

		public Ambiguity(org.eclipse.imp.pdb.facts.INode __param1,
				java.util.List<org.rascalmpl.ast.Declaration> __param2) {
			super(__param1, __param2);
		}
	...
	static public class DataAbstract extends
		...
		public DataAbstract(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Tags __param2,
				org.rascalmpl.ast.Visibility __param3,
				org.rascalmpl.ast.UserType __param4) {
		...
		public org.rascalmpl.ast.Declaration __evaluate(
			...
			__eval.__getAbstractDataTypes().add(this.getUser());
			return this;
	...
	static public class Variable extends org.rascalmpl.ast.Declaration.Variable {
		...
		public Variable(org.eclipse.imp.pdb.facts.INode __param1,
				...
				org.rascalmpl.ast.Visibility __param3,
				org.rascalmpl.ast.Type __param4,
				java.util.List<org.rascalmpl.ast.Variable> __param5) {
			super(__param1, __param2, __param3, __param4, __param5);
		}
		...
		public org.rascalmpl.interpreter.result.Result<org.eclipse.imp.pdb.facts.IValue> __evaluate(
			...
			for (org.rascalmpl.ast.Variable var : this.getVariables()) {
				org.eclipse.imp.pdb.facts.type.Type declaredType = new org.rascalmpl.interpreter.TypeEvaluator(
						__eval.getCurrentModuleEnvironment(), __eval
								.__getHeap()).eval(this.getType());
	...
	static public class Rule extends org.rascalmpl.ast.Declaration.Rule {
		...
		public Rule(org.eclipse.imp.pdb.facts.INode __param1,
				...
				org.rascalmpl.ast.PatternWithAction __param4) {
			super(__param1, __param2, __param3, __param4);
		}
	...
	static public class Tag extends org.rascalmpl.ast.Declaration.Tag {
		...
		public Tag(org.eclipse.imp.pdb.facts.INode __param1,
				org.rascalmpl.ast.Tags __param2,
				org.rascalmpl.ast.Visibility __param3,
				org.rascalmpl.ast.Kind __param4,
				org.rascalmpl.ast.Name __param5,
				java.util.List<org.rascalmpl.ast.Type> __param6) {
			super(__param1, __param2, __param3, __param4, __param5, __param6);
		}
	...
	static public class Data extends org.rascalmpl.ast.Declaration.Data {
		...
		public Data(org.eclipse.imp.pdb.facts.INode __param1,
				...
				org.rascalmpl.ast.Visibility __param3,
				org.rascalmpl.ast.UserType __param4,
				java.util.List<org.rascalmpl.ast.Variant> __param5) {
			super(__param1, __param2, __param3, __param4, __param5);
		}
		...
		public org.rascalmpl.ast.Declaration __evaluate(
			...
			__eval.__getAbstractDataTypes().add(this.getUser());
			__eval.__getConstructorDecls().add(this);
			return this;
