...
public org.rascalmpl.ast.Nonterminal.Ambiguity makeNonterminalAmbiguity(INode node, java.util.List<org.rascalmpl.ast.Nonterminal> alternatives) { 
return new org.rascalmpl.ast.Nonterminal.Ambiguity(node, alternatives); 
}
public org.rascalmpl.ast.Nonterminal.Lexical makeNonterminalLexical(INode node, String string) { 
return new org.rascalmpl.ast.Nonterminal.Lexical(node, string); 
}
public org.rascalmpl.ast.NonterminalLabel.Ambiguity makeNonterminalLabelAmbiguity(INode node, java.util.List<org.rascalmpl.ast.NonterminalLabel> alternatives) { 
return new org.rascalmpl.ast.NonterminalLabel.Ambiguity(node, alternatives); 
}
...
return new org.rascalmpl.ast.Sym.Literal(node, string); 
}
public org.rascalmpl.ast.Sym.CharacterClass makeSymCharacterClass(INode node, org.rascalmpl.ast.Class charClass) { 
return new org.rascalmpl.ast.Sym.CharacterClass(node, charClass); 
}
public org.rascalmpl.ast.Sym.Column makeSymColumn(INode node, org.rascalmpl.ast.IntegerLiteral column) { 
return new org.rascalmpl.ast.Sym.Column(node, column); 
}
public org.rascalmpl.ast.Sym.EndOfLine makeSymEndOfLine(INode node) { 
return new org.rascalmpl.ast.Sym.EndOfLine(node); 
}
public org.rascalmpl.ast.Sym.StartOfLine makeSymStartOfLine(INode node) { 
return new org.rascalmpl.ast.Sym.StartOfLine(node); 
}
public org.rascalmpl.ast.Sym.NonEagerIterStarSep makeSymNonEagerIterStarSep(INode node, org.rascalmpl.ast.Sym symbol, org.rascalmpl.ast.StringConstant sep) { 
return new org.rascalmpl.ast.Sym.NonEagerIterStarSep(node, symbol, sep); 
}
public org.rascalmpl.ast.Sym.NonEagerIterSep makeSymNonEagerIterSep(INode node, org.rascalmpl.ast.Sym symbol, org.rascalmpl.ast.StringConstant sep) { 
return new org.rascalmpl.ast.Sym.NonEagerIterSep(node, symbol, sep); 
}
...
return new org.rascalmpl.ast.Sym.IterStarSep(node, symbol, sep); 
}
...
return new org.rascalmpl.ast.Sym.Labeled(node, symbol, label); 
}
...
public org.rascalmpl.ast.Range.Ambiguity makeRangeAmbiguity(INode node, java.util.List<org.rascalmpl.ast.Range> alternatives) { 
return new org.rascalmpl.ast.Range.Ambiguity(node, alternatives); 
}
public org.rascalmpl.ast.Range.Character makeRangeCharacter(INode node, org.rascalmpl.ast.Char character) { 
return new org.rascalmpl.ast.Range.Character(node, character); 
}
public org.rascalmpl.ast.Class.Union makeClassUnion(INode node, org.rascalmpl.ast.Class lhs, org.rascalmpl.ast.Class rhs) { 
return new org.rascalmpl.ast.Class.Union(node, lhs, rhs); 
}
...
return new org.rascalmpl.ast.Class.Intersection(node, lhs, rhs); 
}
...
return new org.rascalmpl.ast.Class.Difference(node, lhs, rhs); 
}
public org.rascalmpl.ast.Class.Complement makeClassComplement(INode node, org.rascalmpl.ast.Class charClass) { 
return new org.rascalmpl.ast.Class.Complement(node, charClass); 
}
public org.rascalmpl.ast.Class.Bracket makeClassBracket(INode node, org.rascalmpl.ast.Class charclass) { 
return new org.rascalmpl.ast.Class.Bracket(node, charclass); 
}
public org.rascalmpl.ast.Class.Ambiguity makeClassAmbiguity(INode node, java.util.List<org.rascalmpl.ast.Class> alternatives) { 
return new org.rascalmpl.ast.Class.Ambiguity(node, alternatives); 
}
...
public org.rascalmpl.ast.Symbol.Sort makeSymbolSort(INode node, org.rascalmpl.ast.QualifiedName name) { 
...
return new org.rascalmpl.ast.SyntaxDefinition.Layout(node, defined, production); 
}
...
return new org.rascalmpl.ast.SyntaxDefinition.Language(node, start, defined, production); 
}
public org.rascalmpl.ast.Start.Present makeStartPresent(INode node) { 
return new org.rascalmpl.ast.Start.Present(node); 
}
public org.rascalmpl.ast.Start.Ambiguity makeStartAmbiguity(INode node, java.util.List<org.rascalmpl.ast.Start> alternatives) { 
return new org.rascalmpl.ast.Start.Ambiguity(node, alternatives); 
}
public org.rascalmpl.ast.Start.Absent makeStartAbsent(INode node) { 
return new org.rascalmpl.ast.Start.Absent(node); 
}
...
return new org.rascalmpl.ast.Prod.Action(node, prod, action); 
}
...
return new org.rascalmpl.ast.Prod.Unlabeled(node, modifiers, args); 
}
...
return new org.rascalmpl.ast.Prod.Labeled(node, modifiers, name, args); 
}
public org.rascalmpl.ast.Prod.Reference makeProdReference(INode node, org.rascalmpl.ast.Name referenced) { 
return new org.rascalmpl.ast.Prod.Reference(node, referenced); 
}
public org.rascalmpl.ast.Prod.Ambiguity makeProdAmbiguity(INode node, java.util.List<org.rascalmpl.ast.Prod> alternatives) { 
return new org.rascalmpl.ast.Prod.Ambiguity(node, alternatives); 
}
public org.rascalmpl.ast.Prod.Others makeProdOthers(INode node) { 
return new org.rascalmpl.ast.Prod.Others(node); 
}
...
return new org.rascalmpl.ast.LanguageAction.Action(node, statements); 
}
public org.rascalmpl.ast.LanguageAction.Ambiguity makeLanguageActionAmbiguity(INode node, java.util.List<org.rascalmpl.ast.LanguageAction> alternatives) { 
return new org.rascalmpl.ast.LanguageAction.Ambiguity(node, alternatives); 
}
public org.rascalmpl.ast.LanguageAction.Build makeLanguageActionBuild(INode node, org.rascalmpl.ast.Expression expression) { 
return new org.rascalmpl.ast.LanguageAction.Build(node, expression); 
}
public org.rascalmpl.ast.Assoc.Associative makeAssocAssociative(INode node) { 
return new org.rascalmpl.ast.Assoc.Associative(node); 
}
public org.rascalmpl.ast.Assoc.NonAssociative makeAssocNonAssociative(INode node) { 
return new org.rascalmpl.ast.Assoc.NonAssociative(node); 
}
public org.rascalmpl.ast.Assoc.Right makeAssocRight(INode node) { 
return new org.rascalmpl.ast.Assoc.Right(node); 
}
public org.rascalmpl.ast.Assoc.Ambiguity makeAssocAmbiguity(INode node, java.util.List<org.rascalmpl.ast.Assoc> alternatives) { 
return new org.rascalmpl.ast.Assoc.Ambiguity(node, alternatives); 
}
public org.rascalmpl.ast.Assoc.Left makeAssocLeft(INode node) { 
return new org.rascalmpl.ast.Assoc.Left(node); 
}
public org.rascalmpl.ast.ProdModifier.Lexical makeProdModifierLexical(INode node) { 
return new org.rascalmpl.ast.ProdModifier.Lexical(node); 
}
public org.rascalmpl.ast.ProdModifier.Bracket makeProdModifierBracket(INode node) { 
return new org.rascalmpl.ast.ProdModifier.Bracket(node); 
}
public org.rascalmpl.ast.ProdModifier.Ambiguity makeProdModifierAmbiguity(INode node, java.util.List<org.rascalmpl.ast.ProdModifier> alternatives) { 
return new org.rascalmpl.ast.ProdModifier.Ambiguity(node, alternatives); 
}
...
return new org.rascalmpl.ast.ProdModifier.Associativity(node, associativity); 
}
...
public org.rascalmpl.ast.OctalEscapeSequence.Ambiguity makeOctalEscapeSequenceAmbiguity(INode node, java.util.List<org.rascalmpl.ast.OctalEscapeSequence> alternatives) { 
return new org.rascalmpl.ast.OctalEscapeSequence.Ambiguity(node, alternatives); 
}
public org.rascalmpl.ast.OctalEscapeSequence.Lexical makeOctalEscapeSequenceLexical(INode node, String string) { 
return new org.rascalmpl.ast.OctalEscapeSequence.Lexical(node, string); 
}
...
public org.rascalmpl.ast.CaseInsensitiveStringConstant.Ambiguity makeCaseInsensitiveStringConstantAmbiguity(INode node, java.util.List<org.rascalmpl.ast.CaseInsensitiveStringConstant> alternatives) { 
return new org.rascalmpl.ast.CaseInsensitiveStringConstant.Ambiguity(node, alternatives); 
}
...
return new org.rascalmpl.ast.CaseInsensitiveStringConstant.Lexical(node, string); 
}
...
return new org.rascalmpl.ast.Import.Syntax(node, syntax); 
}
...
return new org.rascalmpl.ast.BasicType.ReifiedTypeParameter(node); 
}
